...
public:
    AddTwoIntsClientNode() : Node("add_two_ints_client")
    {
        ...
        threads_.push_back(std::thread(std::bind(&AddTwoIntsClientNode::callbackAddTwoIntsService, this, 1, 4)));
        threads_.push_back(std::thread(std::bind(&AddTwoIntsClientNode::callbackAddTwoIntsService, this, 2, 6)));
    }
